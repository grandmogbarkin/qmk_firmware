...
#define LED_IS_EDGE(led)           (led.scan >= LED_EDGE_MIN_SCAN)     //Return true if an LED's scan value indicates an edge LED
#define LED_IS_EDGE_ALT(led)       (led.scan >= LED_EDGE_ALT_MODE && led.id % 2)     //Return true if an LED's scan value indicates an alternate edge mode LED
