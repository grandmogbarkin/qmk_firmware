...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        L_T_PTD,         L_PTP,   L_BRD,   L_PTN,   L_EDG_D, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          P_SCRMAX,
...
led_instruction_t led_instructions[] = {
    ...
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .layer = 1, .id0 = 2048, .id1 = 448, .id2 = 16, .id3 = 0, .r = 255, .g = 0, .b = 0 },
