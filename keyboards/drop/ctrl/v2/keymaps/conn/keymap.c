...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_tkl_ansi(
        ...
        RGB_MODE_KNIGHT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    KC_MPLY, KC_MSTP, KC_VOLU,
        _______,         RGB_TOG, RGB_VAI, RGB_SPI, RGB_HUI, RGB_SAI, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    KC_MPRV, KC_MNXT, KC_VOLD,
        _______,         RGB_MOD, RGB_VAD, RGB_SPD, RGB_HUD, RGB_SAD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          P_SCRMAX,
        _______,                  RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW,XXXXXXX, NK_TOGG, XXXXXXX, XXXXXXX, LCTL(LSFT(KC_S)), P_LOCK, LGUI(LSFT(KC_H)),     _______,
        MO(2),           _______, _______,                            EE_CLR,                             P_WINRST,_______, _______, TO(CODE_LAYER),      _______, _______, _______
    ),
    [2] = LAYOUT_tkl_ansi(
